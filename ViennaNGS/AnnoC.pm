#!/usr/bin/perl -w
# -*-CPerl-*-
# Last changed Time-stamp: <2013-09-16 14:36:44 mtw>
#
#
# ***********************************************************************
# *  Copyright notice
...
# get_fasta_ids($fastafile)
# Returns an array with all fasta ids from a (multi)fasta file
#
# ARG1: fasta file
sub get_fasta_ids {
  my $in_file = shift;
  $fastadb = Bio::DB::Fasta->new($in_file) or die $!;
...
get_fasta_ids returns an array containing all fasta headers (ids) of a
(multi-) fasta file.

=head1 EXPORT

Routines: parse_gff() feature_summary() get_fasta_ids()

Variables: $feat $fstat $fastadb
           @fastaids
