...
use Bio::ViennaNGSutil qw(kmer_enrichment);
...
KmerAnalysis.pl - Simple k-mer count analysis of fasta or fastq files

=head1 SYNOPSIS

KmerAnalysis.pl [-f I<FILE>] [-d I<STRING>] [-o I<STRING>] [-k I<INTEGER>] [-t I<STRING>]
[options]
