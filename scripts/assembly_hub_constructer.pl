...
sub usage {
  print <<EOF;
Build assembly hubs for the UCSC genome browser. The input is fasta file, optionally big bed files for tracks
(placed in the same folder), a output path for the resulting assembly hub folder and the URL where this
folder will be made available for upload to UCSC.
