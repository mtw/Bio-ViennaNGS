# -*-CPerl-*-
# Last changed Time-stamp: <2015-10-27 14:44:46 mtw>
...
chain as generated by L<parse_bed6>.

This chain is then either extended to the desired minimal size, extend
from either the 5' and/or 3' end of the chain or returns only the 5'
